 ...
 *
 */
public class Confidentialitycodepage extends TestBaseClass {
	...
	@CacheLookup
	WebElement codesystem;

	@FindBy(xpath = "//input[@class='actionBtnSmall' and @title='Save']")
	@CacheLookup
	WebElement savebtn;

	@FindBy(xpath = "//td[@class='normal'][3]/input")
	@CacheLookup
	...
	public Confidentialitycodepage() {
	...
	public void enterCodesystem(String desc) {
		codesystem.sendKeys(desc);

	}

	public void enterdisplayname(String desc) {
		displayname.sendKeys(desc);
