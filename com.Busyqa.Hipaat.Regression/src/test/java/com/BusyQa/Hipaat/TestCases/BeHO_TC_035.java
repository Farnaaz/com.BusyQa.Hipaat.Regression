...
import com.BusyQa.Hipaat.PageObjects.AssigningAuthoritypage;
...
/**
 * @author Farnaaz
 * ---This testcase ensures that values can be added and deleted in Assigning authority page -----
 *
...
public class BeHO_TC_035 extends TestBaseClass{

	Loginpage login;
	Menupage menu;
	AssigningAuthoritypage authority;
	...
	public void TC_035_authority() {
		...
		try {
			...
			menu.clickAssigningauthority();
			log.info("*****entered Assigning authority page*****");

			//AC01: Values will be added to Confidentiality code table as TEST123
			authority = new AssigningAuthoritypage();
			...
			authority.enterAuthorityID("2.10.840.1.113883.3.239.15.300");
			authority.enterDescription("Hospital");
			authority.enterAssignmentAuthoritytype("Medical Record Number");
			authority.clickSave();
			...
			softAssert.assertTrue(pageSource.contains("2.10.840.1.113883.3.239.15.300"));
			...
			driver.findElement(By.xpath("//span[text()='2.10.840.1.113883.3.239.15.300']//parent::td/following-sibling::td[3]//div//input[@title='Delete']")).click();
	...
	public void tearDown() {
		...
		driver.quit();
		log.info("***** BeHO_TC_035 Test case completed, Browser closed*****");
	}
