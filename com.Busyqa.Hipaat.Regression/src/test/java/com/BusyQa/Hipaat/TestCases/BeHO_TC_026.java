 ...
 * @author Farnaaz
 * 
 * -----This testcase is to create a policy with one system directive and perform check ----
...
public class BeHO_TC_026 extends TestBaseClass{
	...
	@Test
	public void TC_026_systemConsentDir() {
		...
		//AC03: Verify created Policy is displayed in policy table	
...
@AfterMethod
	public void tearDown() {
		...
		driver.quit();
		log.info("***** BeHO_TC_026 Test case completed, Browser closed*****");
	}
}
