...
import com.BusyQa.Hipaat.PageObjects.Confidentialitycodepage;
...
/**
 * @author Farnaaz
 * ---This testcase ensures that values can be added and deleted in Confidentiality Code page -----
 *
...
public class BeHO_TC_033 extends TestBaseClass{

	Loginpage login;
	Menupage menu;
	Confidentialitycodepage confidentiality;
	...
	@Test
	public void TC_033_confidentiality() {
		...
		try {
			...
			menu.clickConfidentialitycode();
			log.info("*****entered Confidentiality code page*****");

			//AC01: Values will be added to Confidentiality code table as TEST123
			confidentiality = new Confidentialitycodepage();
			...
			confidentiality.enterCodevalue("TEST123");
			confidentiality.enterCodesystem("HL7v3");
			confidentiality.enterdisplayname("this is for testing purpose");
			confidentiality.clickSave();
	...
	public void tearDown() {
		...
		driver.quit();
		log.info("***** BeHO_TC_033 Test case completed, Browser closed*****");
	}
